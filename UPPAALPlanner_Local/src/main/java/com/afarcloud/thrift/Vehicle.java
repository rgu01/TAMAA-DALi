...
public class Vehicle implements org.apache.thrift.TBase<Vehicle, Vehicle._Fields>, java.io.Serializable, Cloneable, Comparable<Vehicle> {
  ...
  private static class VehicleStandardScheme extends StandardScheme<Vehicle> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Vehicle struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = VehicleType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem12 = TaskType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Vehicle struct) throws TException {
      struct.validate();
  ...
  private static class VehicleTupleScheme extends TupleScheme<Vehicle> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Vehicle struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Vehicle struct) throws TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          {
            _elem22 = TaskType.findByValue(iprot.readI32());
