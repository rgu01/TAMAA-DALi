...
public class TaskTemplate implements org.apache.thrift.TBase<TaskTemplate, TaskTemplate._Fields>, java.io.Serializable, Cloneable, Comparable<TaskTemplate> {
  ...
  private static class TaskTemplateStandardScheme extends StandardScheme<TaskTemplate> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TaskTemplate struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // REGION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.regionType = TaskRegionType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem25 = EquipmentType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskTemplate struct) throws TException {
      struct.validate();
  ...
  private static class TaskTemplateTupleScheme extends TupleScheme<TaskTemplate> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TaskTemplate struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TaskTemplate struct) throws TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          {
            _elem30 = EquipmentType.findByValue(iprot.readI32());
